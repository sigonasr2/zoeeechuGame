...
#define APP_VIRTUAL_WIDTH		(1000)					// This will be the effective x resolution regardless of actual screen/window res.
...
#define APP_KEYBOARD_EVENT_LEFT_MOUSE     (VK_LBUTTON)
#define APP_KEYBOARD_EVENT_RIGHT_MOUSE    (VK_RBUTTON)
